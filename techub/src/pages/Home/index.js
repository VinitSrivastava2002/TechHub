          ...
          <div className="container">
            ...
            <div className="row" data-aos="zoom-in">
              ...
              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\Android.png" className="img-fluid" alt="Android" />
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\Docker.png" className="img-fluid" alt="Docker" />
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\GitHub.png" className="img-fluid" alt="Github" />
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\Kubernetes.png" className="img-fluid" alt="Kubernative" />
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\Pandas.png" className="img-fluid" alt="Pandas" />
              </div>
              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <img src="assets\images\Technoogies-icon\Python.png" className="img-fluid" alt="Python" />
              </div>
            </div>
          </div>
        </section>
